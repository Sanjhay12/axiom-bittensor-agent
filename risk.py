...
ENTRY_SCORE_THRESHOLD = 5     # min score to consider entry                         
ENTRY_CYCLES_REQUIRED = 2     # consecutive cycles above threshold before entering
EXIT_SCORE_THRESHOLD = -3     # exit immediately if score drops below this

STOP_LOSS = 0.15              # exit if position down 15%
TAKE_PROFIT = 0.40            # exit if position up 40%
